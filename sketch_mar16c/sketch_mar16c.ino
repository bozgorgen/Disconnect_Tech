...
//ENCODER 
#define RIGHT_CH_1 D1
#define RIGHT_CH_2 D2
#define LEFT_CH_1 D5
#define LEFT_CH_2 D6
...
void setup() {
  ...
  left_channel1_prev=0;
  left_channel2_prev=0;
  //ENCODER
...
velocity_left=velocity_left/3000.0*21.67*5;
velocity_right=velocity_right/3000.0*21.67*5;
...
//CONTROLLER
set_velocity_right=20;
set_velocity_left=20;
...
if(actuator_right_dir)
  {
    ...
    analogWrite(D3,actuator_right);
    analogWrite(D4,0);  
  }  
else  
  {
    analogWrite(D3,0);
    analogWrite(D4,actuator_right);    
  }   

if(actuator_left_dir)
  {
  
    analogWrite(D7,actuator_left);
    analogWrite(D8,0);  
  }  
else  
  {
    analogWrite(D7,0);
    analogWrite(D8,actuator_left);    
  } 
...
/*
Serial.print(',');
Serial.print(actuator_right/5);
Serial.print(',');
Serial.print(actuator_left/5);
Serial.print(',');
